...
function paintPackage(){const code=form.elements.namedItem('package').value;$('#gift-duration').textContent=code==='gift_120'?'Película de 2 minutos':'Película de 1 minuto';saveDraft();}
