...
export function ideaComposer({task,tell,brands,create,openBrand,home,getProject}){
 let fingerprint=null,brandId=null,creative={format:'auto',look:'auto'},file=null,requestId=null,currentProject=null;
 ...
 $('#idea-form').onsubmit=e=>{e.preventDefault();task(async()=>{
  ...
  if(!brands().some(b=>b.id===brandId)){chooseProduct();return;}
