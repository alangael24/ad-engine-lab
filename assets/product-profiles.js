...
export function productProfile(data={}){
 ...
 if(![CONTINUITY_PRODUCT,SALES_PRODUCT].includes(profile))throw Object.assign(Error('STUDIO_INVALID'),{code:'STUDIO_INVALID'});
 return profile;
}
export const isSalesProduct=data=>productProfile(data)===SALES_PRODUCT;
export const productPath=data=>isSalesProduct(data)?'/anuncios-lab/':'/estudio/';
