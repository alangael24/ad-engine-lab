...
export function giftRequest(raw,photos=[]){
 ...
 const data=creatorRequest(idea,{kind:'story',targetDuration:60,aspectRatio:raw.ratio,creative:{format:'auto',look:raw.look},characterAssetIds:photos.map(p=>p.id)});
