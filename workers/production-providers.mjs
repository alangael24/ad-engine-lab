...
export async function callDirector(project,env,{fetchImpl=fetch,catalog=[]}={}){
 const schema={type:'object',additionalProperties:false,properties:{continuity:{type:'string',maxLength:2000},scenes:{type:'array',minItems:1,maxItems:12,items:{type:'object',additionalProperties:false,properties:{text:{type:'string',maxLength:500},visual:{type:'string',maxLength:800},motion:{type:'string',maxLength:400},sourceKey:{type:'string',maxLength:80}},required:['text','visual','motion']}}},required:['continuity','scenes']};
