...
export async function editFingerprint(edl,readAsset){
 const actual={ranges:edl.ranges.map(({source,start,end})=>({source,start,end})),output:edl.output,grade:edl.grade||'none',subtitles:!!edl.subtitles,caption_words:edl.caption_words,caption_case:edl.caption_case,subtitle_style:edl.subtitle_style,caption_exclusions:edl.caption_exclusions||[],overlays:[]};
