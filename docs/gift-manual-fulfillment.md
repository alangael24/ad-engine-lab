...
La web recibe la historia y las referencias privadas. No invoca OpenAI ni crea trabajos de GPU. El operador revisa periódicamente los pedidos; todavía no hay notificación automática. La oferta estándar anuncia 24 horas; la opción de dos minutos tiene entrega prioritaria en una hora.

1. El cliente envía el formulario en `/regalos/`; el pedido aparece en `/regalos/pedido/` y el cliente pasa a `/regalos/checkout/?id=…` para revisar el resumen y abrir Stripe. El checkout recupera el paquete desde el pedido de la cuenta y permite continuar sin compra si ya hay saldo suficiente.
...
- $299 MXN: Un recuerdo especial, un minuto, entrega estándar en 24 horas.
- $499 MXN: Nuestra historia, dos minutos, Más popular, entrega prioritaria en una hora.
...
- Esto sigue siendo cumplimiento manual: no hay un planificador ni alertas automáticas para estos plazos. El operador debe cumplir el plazo publicado de una hora para el paquete prioritario.
